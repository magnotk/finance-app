...
export default function Card({ data }: Props) {
  const RenderExpense = ({ data }: { data: Expense[] }) => {
    return (
      <section className="my-2 flex w-full flex-col justify-between rounded-md bg-neutral-200 shadow">
        <div className="flex min-h-16 flex-col items-center justify-center pb-10">
  ...
  const RenderExpenseLate = ({ data }: { data: Expense[] }) => {
    return (
      <section className="my-2 w-full rounded-md bg-neutral-200 shadow">
        <div className="flex min-h-16 w-full flex-col items-center justify-center pb-5">
